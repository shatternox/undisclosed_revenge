  ...
  <section class="food_section layout_padding-bottom layout_padding-top">
    <div class="container">
      ...
      <ul class="filters_menu" id="shop">
        ...
        <li data-filter=".full">Fullface</li>
        <li data-filter=".hacker">Hackerman</li>
      </ul>

      <div class="filters-content">
        <div class="row grid">
          <div class="col-sm-6 col-lg-4 all covid">
            <div class="box">
              <div>
                <div class="img-box">
            ...
            <div class="box">
              <div>
                ...
                <div class="detail-box">
                  ...
                  <p>
                  Protect your secrecy with 20% efficiency
                  </p>
                  <div class="options">
                    <h6>
                      $15
          ...
          <div class="col-sm-6 col-lg-4 all hacker">
            <div class="box">
              <div>
                <div class="img-box">
          ...
          <div class="col-sm-6 col-lg-4 all eye">
            <div class="box">
              <div>
                <div class="img-box">
                ...
                <div class="detail-box">
                  ...
                  <p>
                  Protect your secrecy with 45% efficiency
                  </p>
                  <div class="options">
                    <h6>
                      $18
            ...
            <div class="box">
              <div>
                ...
                <div class="detail-box">
                  ...
                  <p>
                  Protect your secrecy with 40% efficiency
                  </p>
                  <div class="options">
                    <h6>
                      $10
          ...
          <div class="col-sm-6 col-lg-4 all full">
            <div class="box">
              <div>
                <div class="img-box">
                ...
                <div class="detail-box">
                  ...
                  <p>
                  Protect your secrecy with 98% efficiency
                  </p>
                  <div class="options">
                    <h6>
                      $150
        ...
        <div class="col-md-6">
          <div class="form_container">
            <form method="POST" action="./controller/maskController.php" enctype="multipart/form-data">
              ...
              <div>
                <label for="formFile" class="form-label">Mask Design</label>
              </div>
              <div>
                <input type="file" class="" placeholder="Mask Design" accept=".jpg,.png,.jpeg" required>
              </div>
              <div class="btn_box">
                <button>
                  Order Now
        ...
        <div class="owl-carousel client_owl-carousel">
          <div class="item">
            <div class="box">
              <div class="detail-box">
                <p>
                  Don't buy the Robbing Hood mask!
                </p>
                <h6>
                  Stanley Halim
                </h6>
                <p>
                  Prisoner #823 at Nusakambangan
                </p>
              </div>
              <div class="img-box">
          ...
          <div class="item">
            <div class="box">
              <div class="detail-box">
                <p>
                  Hey that's my face on The Anti-social mask. It's not even a snot..
                </p>
                <h6>
                  Ben Jackinoff
                </h6>
